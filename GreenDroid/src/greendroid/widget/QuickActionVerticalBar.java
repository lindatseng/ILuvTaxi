 ...
 */
public class QuickActionVerticalBar extends QuickActionWidget {
    ...
    public QuickActionVerticalBar(Context context) {
        super(context);
        ...
        mScrollView = (ScrollView) v.findViewById(R.id.gdi_v_scroll);
    }
            ...
            if (listener != null) {
                ...
                for (int i = 0; i < itemCount; i++) {
                    if (view == mQuickActions.get(i).mView.get()) {
                        listener.onQuickActionClicked(QuickActionVerticalBar.this, i);
                        break;
                    }
                }
            }
